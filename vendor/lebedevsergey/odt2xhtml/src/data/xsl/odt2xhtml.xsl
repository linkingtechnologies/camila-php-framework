...
<xsl:stylesheet version="1.0"
            ...
            <xsl:element name="head">
                ...
                <xsl:element name="link">
                    ...
                    <xsl:attribute name="href">
                        <xsl:text>img/favicon.ico</xsl:text>
                    </xsl:attribute>
                    <xsl:attribute name="type">
                        <xsl:text>image/vnd.microsoft.icon</xsl:text>
                    </xsl:attribute>
                </xsl:element>
                <xsl:element name="link">
                    <xsl:attribute name="rel">
                    ...
                    <xsl:attribute name="href">
                        <xsl:text>img/icone.png</xsl:text>
                    </xsl:attribute>
                    <xsl:attribute name="type">
    ...
    <xsl:template match="dc:creator">
        <xsl:element name="meta">
            <xsl:attribute name="name">
                <xsl:text>DC.Contributor</xsl:text>
            </xsl:attribute>
            <xsl:attribute name="content">
    ...
    <xsl:template match="dc:date">
        ...
        <xsl:element name="meta">
            <xsl:attribute name="name">
                <xsl:text>DC.Date.modified</xsl:text>
            </xsl:attribute>
            <xsl:attribute name="content">
                <xsl:value-of select="current()"/>
            </xsl:attribute>
    ...
    <xsl:template match="meta:creation-date">
        ...
        <xsl:element name="meta">
            <xsl:attribute name="name">
                <xsl:text>DC.Date.dateCopyrighted</xsl:text>
            </xsl:attribute>
            <xsl:attribute name="content">
                <xsl:value-of select="current()"/>
            </xsl:attribute>
    ...
    <xsl:template match="text:h/@text:outline-level" mode="toc-styles">
        ...
        <xsl:text>.toc_outline_level_</xsl:text><xsl:value-of select="."/><xsl:text> { margin-left: </xsl:text><xsl:value-of
            select="round(.*0.5*28.6264)"/><xsl:text>px; }&#xa;</xsl:text>
        <xsl:value-of select="$linebreak"/>
