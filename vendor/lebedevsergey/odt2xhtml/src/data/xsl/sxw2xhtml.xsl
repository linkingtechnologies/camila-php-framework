				...
				<xsl:element name="span">
					...
					<xsl:if test="//svg:desc">
						<xsl:attribute name="style">
							...
							<xsl:if test="draw:image/@svg:width">width: <xsl:value-of
									select="substring-before(draw:image/@svg:width,'px')"/>px;
							</xsl:if>
							<xsl:if test="draw:image/@svg:height">height: <xsl:value-of
									select="substring-before(draw:image/@svg:height,'px')"/>px;
							</xsl:if>
						</xsl:attribute>
					</xsl:if>
					<xsl:choose>
